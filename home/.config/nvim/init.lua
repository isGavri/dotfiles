...
-- Navigating throug buffers
vim.keymap.set('n', '<S-l>', ':bn<CR>', { desc = 'Go to next buffer' })
vim.keymap.set('n', '<S-h>', ':bN<CR>', { desc = 'Go to previous buffer' })
...
-- autocommand for saving on write on latex
vim.api.nvim_create_autocmd('InsertLeave', {
  desc = 'Autosave when leaving insert mode in tex',
  pattern = '*.tex',
...
local group_styles = {
  ...
  ['GitSignsStagedChange'] = { fg = '#aaaaaa', italic = false },
  ['GitSignsStagedChangeDelete'] = { fg = '#aaaaaa', italic = false },
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'latexindent', -- Format latex code
        'ast_grep', -- Format C, Java, Python, Rust etc
        'black', -- Format python
        'clang-format', -- Format C, Java
      })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        java = { 'clang-format', 'ast_grep' },
        python = { 'black', 'ast_grep' },
        latex = { 'latexindent' },
        rust = { 'ast_grep' },
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      -- Lazy load snippets for latex
      require('luasnip.loaders.from_lua').lazy_load { paths = { '~/.config/nvim-kickstart/lua/LuaSnip/' } }
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- Comment this line to get default 'medium'
